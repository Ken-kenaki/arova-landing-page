        ...
        >
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  required
                  className="w-full pl-11 pr-4 py-3.5 rounded-xl text-sm text-white placeholder-[#A7ABB3]/30 outline-none transition-all duration-300 bg-white/[0.04] border border-white/[0.08] focus:bg-white/[0.07] focus:border-pink-400/40 focus:ring-2 focus:ring-pink-400/10"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="w-full pl-11 pr-12 py-3.5 rounded-xl text-sm text-white placeholder-[#A7ABB3]/30 outline-none transition-all duration-300 bg-white/[0.04] border border-white/[0.08] focus:bg-white/[0.07] focus:border-pink-400/40 focus:ring-2 focus:ring-pink-400/10"
                />
                <button
                  type="button"
          ...
          <div className="mt-10 pt-6 flex flex-col items-center border-t border-white/[0.06] gap-3">
            <div className="flex items-center gap-1.5">
              <div className="w-2 h-2 rounded-full bg-pink-400 animate-pulse shadow-[0_0_8px_#ec4899]" />
